...
function addBody(){
  ...
  var body1 = new Array(
              { text: 'Kassaflöden (nuvärdesberäknade)', style: 'tableHeader', colSpan: 19 },
              { text: '' },
              { text: '' },
              { text: '' },
              { text: '' },
  ...
  for(var i = 4; i < 55; i++) {
              ...
              var restBody = new Array( 
                { text: numberWithSpaces($("#a-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#b-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#c-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#d-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#e-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#f-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#g-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#h-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#i-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#j-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#k-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#l-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#m-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#n-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#o-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#p-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#q-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#r-"+i).val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#s-"+i).val()), style: 'cashFlowValue'});

              bodies.push(restBody);
            }
            var restBody = new Array({ text: 'Summa', style: 'cashFlowHeader', fontSize: 13},
                { text: numberWithSpaces($("#b-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#c-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#d-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#e-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#f-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#g-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#h-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#i-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#j-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#k-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#l-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#m-55").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#n-55").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'},
                { text: numberWithSpaces($("#p-55").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'},
                { text: numberWithSpaces($("#r-55").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'});
            bodies.push(restBody);
    return bodies;
}
...
function addBodySecond(){
  ...
  var body1 = new Array(
              { text: 'Kassaflöden (utan nuvärdesberäknade, för beräkning av IRR)', style: 'tableHeader', colSpan: 19 },
              { text: '' },
              { text: '' },
              { text: '' },
              { text: '' },
  ...
  for(var i = 60; i < 111; i++) {
            ...
            var restBody = new Array({ text: 'Summa', style: 'cashFlowHeader', fontSize: 13},
                { text: numberWithSpaces($("#b-111").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'},
                { text: numberWithSpaces($("#d-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#e-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#f-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#g-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#h-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#i-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#j-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#k-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#l-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#m-111").val()), style: 'cashFlowValue'},
                { text: numberWithSpaces($("#n-111").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'},
                { text: numberWithSpaces($("#p-111").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'},
                { text: numberWithSpaces($("#r-111").val()), style: 'cashFlowValue'},
                { text: '', style: 'cashFlowValue'});
            bodies.push(restBody);
    return bodies;
}
          ...
          columns: [
            {
              table: {
                ...
                body: [
                  ...
                  [ { text: 'Anläggningens effekt [' + $("#indata-unit-18").text() + ']', style: 'tableDescription'}, { text: $("#indata-18").val(), style: 'tableValue'} ],
                  [ { text: 'Modulyta [' + $("#indata-unit-19").text() + ']', style: 'tableDescription'}, { text: $("#indata-19").val(), style: 'tableValue'} ],
                  [ { text: 'Säkringsstorlek i anslutningspunkten [' + $("#indata-unit-20").text() + ']', style: 'tableDescription'}, { text: $("#indata-20").val(), style: 'tableValue'} ],

                  [ { text: 'Ekonomisk livslängd (N)', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Ekonomisk livslängd [' + $("#indata-unit-24").text() + ']', style: 'tableDescription'}, { text: $("#indata-24").val(), style: 'tableValue'} ],

                  [ { text: 'Kalkylränta (R)', style: 'sectionHeader'}, { text: '' } ],
                  [ { text: 'Kalkylränta [' + $("#indata-unit-28").text() + ']', style: 'tableDescription'}, { text: $("#indata-28").val(), style: 'tableValue'} ],

                  [ { text: 'Investering', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Investeringskostnad solcellsanläggning, utan stöd eller ROT-avdrag [' + $("#indata-unit-32").text() + ']', style: 'tableDescription'}, { text: $("#indata-32").val(), style: 'tableValue'} ],
                  [ { text: 'Investeringsstöd [' + $("#indata-unit-33").text() + ']', style: 'tableDescription'}, { text: $("#indata-33").val(), style: 'tableValue'} ],
                  [ { text: 'Bygglov [' + $("#indata-unit-35").text() + ']', style: 'tableDescription'}, { text: $("#indata-35").val(), style: 'tableValue'} ],
                  [ { text: 'Projektledning och upphandling [' + $("#indata-unit-36").text() + ']', style: 'tableDescription'}, { text: $("#indata-36").val(), style: 'tableValue'} ],
                  [ { text: 'Besiktning efter färdigställande [' + $("#indata-unit-37").text() + ']', style: 'tableDescription'}, { text: $("#indata-37").val(), style: 'tableValue'} ],
                  [ { text: 'Utbildning [' + $("#indata-unit-38").text() + ']', style: 'tableDescription'}, { text: $("#indata-38").val(), style: 'tableValue'} ],

                  [ { text: 'Summa investering under livslängden', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Utan ROT-avdrag eller investeringsstöd [' + $("#indata-unit-41").text() + ']', style: 'tableDescription'}, { text: $("#indata-41").val(), style: 'tableValue'} ],
                  [ { text: 'Med ROT-avdrag [' + $("#indata-unit-42").text() + ']', style: 'tableDescription'}, { text: $("#indata-42").val(), style: 'tableValue'} ],
                  [ { text: 'Med investeringsstöd [' + $("#indata-unit-43").text() + ']', style: 'tableDescription'}, { text: $("#indata-43").val(), style: 'tableValue'} ],

                  [ { text: 'Driftkostnad', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Årlig fast driftkostnad som inte beror på anläggningens storlek [' + $("#indata-unit-47").text() + ']', style: 'tableDescription'}, { text: $("#indata-47").val(), style: 'tableValue'} ],
                  [ { text: 'Årlig rörlig driftkostnad som beror på anläggningens storlek [' + $("#indata-unit-48").text() + ']', style: 'tableDescription'}, { text: $("#indata-48").val(), style: 'tableValue'} ],
                  [ { text: 'Summa årliga kostnader [' + $("#indata-unit-49").text() + ']', style: 'tableDescription'}, { text: $("#indata-49").val(), style: 'tableValue'} ],

                  [ { text: 'Energiutbyte', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Energiutbyte första året [' + $("#indata-unit-53").text() + ']', style: 'tableDescription'}, { text: $("#indata-53").val(), style: 'tableValue'} ],
                  [ { text: 'Summa solelproduktion under livslängden [' + $("#indata-unit-54").text() + ']', style: 'tableDescription'}, { text: $("#indata-54").val(), style: 'tableValue'} ],
                  [ { text: 'Summa solelproduktion berättigad till elcertifikat [' + $("#indata-unit-55").text() + ']', style: 'tableDescription'}, { text: $("#indata-55").val(), style: 'tableValue'} ],

                  [ { text: 'Intäkter', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Andel egenanvänd el [' + $("#indata-unit-60").text() + ']', style: 'tableDescription'}, { text: $("#indata-60").val(), style: 'tableValue'} ],
                  [ { text: 'Pris köpt el [' + $("#indata-unit-61").text() + ']', style: 'tableDescription'}, { text: $("#indata-61").val(), style: 'tableValue'} ],
                  [ { text: 'Pris såld el [' + $("#indata-unit-62").text() + ']', style: 'tableDescription'}, { text: $("#indata-62").val(), style: 'tableValue'} ],
                  [ { text: 'Ersättning från nätägare [' + $("#indata-unit-63").text() + ']', style: 'tableDescription'}, { text: $("#indata-63").val(), style: 'tableValue'} ],
                  [ { text: 'Elcertifikatvärde [' + $("#indata-unit-64").text() + ']', style: 'tableDescription'}, { text: $("#indata-64").val(), style: 'tableValue'} ],
                  [ { text: 'Andel solel som ger elcertifikat [' + $("#indata-unit-65").text() + ']', style: 'tableDescription'}, { text: $("#indata-65").val(), style: 'tableValue'} ],
                  [ { text: 'Kvotplikt medelvärde [' + $("#indata-unit-66").text() + ']', style: 'tableDescription'}, { text: $("#indata-66").val(), style: 'tableValue'} ],
                  [ { text: 'Ursprungsgarantier värde [' + $("#indata-unit-67").text() + ']', style: 'tableDescription'}, { text: $("#indata-67").val(), style: 'tableValue'} ],
                  [ { text: 'Antal år med skattereduktion [' + $("#indata-unit-68").text() + ']', style: 'tableDescription'}, { text: $("#indata-68").val(), style: 'tableValue', pageBreak: 'after'} ],

                  [ { text: 'Beräknad produktionskostnad (LCOE)', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Utan ROT-avdrag eller investeringsstöd [' + $("#indata-unit-72").text() + ']', style: 'tableDescription'}, { text: $("#indata-72").val(), style: 'tableValue'} ],
                  [ { text: 'Med ROT-avdrag [' + $("#indata-unit-73").text() + ']', style: 'tableDescription'}, { text: $("#indata-73").val(), style: 'tableValue'} ],
                  [ { text: 'Med investeringsstöd [' + $("#indata-unit-74").text() + ']', style: 'tableDescription'}, { text: $("#indata-74").val(), style: 'tableValue'} ],
                  ...
                  [ { text: 'Nuvärde [' + $("#indata-unit-82").text() + ']', style: 'tableDescription'}, { text: $("#indata-82").val(), style: 'tableValue'} ],
                  [ { text: 'Diskonterad återbetalningstid [' + $("#indata-unit-83").text() + ']', style: 'tableDescription'}, { text: $("#indata-83").val(), style: 'tableValue'} ],
                  [ { text: 'Internränta (IRR) [' + $("#indata-unit-84").text() + ']', style: 'tableDescription'}, { text: $("#indata-84").val(), style: 'tableValue'} ],
                  [ { text: 'Med ROT-avdrag och eventuell skattereduktion', style: 'tableSubSection'}, { text: '', } ],
                  [ { text: 'Nuvärde [' + $("#indata-unit-87").text() + ']', style: 'tableDescription'}, { text: $("#indata-87").val(), style: 'tableValue'} ],
                  [ { text: 'Diskonterad återbetalningstid [' + $("#indata-unit-88").text() + ']', style: 'tableDescription'}, { text: $("#indata-88").val(), style: 'tableValue'} ],
                  [ { text: 'Internränta (IRR) [' + $("#indata-unit-89").text() + ']', style: 'tableDescription'}, { text: $("#indata-89").val(), style: 'tableValue'} ],
                  [ { text: 'Med investeringsstöd och eventuell skattereduktion', style: 'tableSubSection'}, { text: '', } ],
                  [ { text: 'Nuvärde [' + $("#indata-unit-92").text() + ']', style: 'tableDescription'}, { text: $("#indata-92").val(), style: 'tableValue'} ],
                  [ { text: 'Diskonterad återbetalningstid [' + $("#indata-unit-93").text() + ']', style: 'tableDescription'}, { text: $("#indata-93").val(), style: 'tableValue'} ],
                  [ { text: 'Internränta (IRR) [' + $("#indata-unit-94").text() + ']', style: 'tableDescription'}, { text: $("#indata-94").val(), style: 'tableValue'} ],
                ],
              },
            ...
            },
            {
              ...
              width: '50%',
                ...
                body: [
                  [ { text: 'Grundläggande antaganden', style: 'tableHeader' }, { text: '', }],
                  [ { text: 'Anläggning', style: 'sectionHeader' }, { text: '', }],
                  [ { text: 'Verkningsgrad solcellsmoduler [' + $("#extended-unit-12").text() + ']', style: 'tableDescription'}, { text: $("#extended-12").val(), style: 'tableValue'} ],

                  [ { text: 'Investering', style: 'sectionHeader' }, { text: '', }],
                  [ { text: 'Tak för investeringsstöd [' + $("#extended-unit-16").text() + ']', style: 'tableDescription'}, { text: $("#extended-16").val(), style: 'tableValue'} ],
                  [ { text: 'ROT-avdrag arbetskostnad [' + $("#extended-unit-17").text() + ']', style: 'tableDescription'}, { text: $("#extended-17").val(), style: 'tableValue'} ],
                  [ { text: 'Tak för ROT-avdrag [' + $("#extended-unit-18").text() + ']', style: 'tableDescription'}, { text: $("#extended-18").val(), style: 'tableValue'} ],
                  [ { text: 'Kostnad för köp eller preparering av mark [' + $("#extended-unit-20").text() + ']', style: 'tableDescription'}, { text: $("#extended-20").val(), style: 'tableValue'} ],
                  [ { text: 'Nätanslutningskostnad [' + $("#extended-unit-21").text() + ']', style: 'tableDescription'}, { text: $("#extended-21").val(), style: 'tableValue'} ],
                  [ { text: 'Antal byten av växelriktare', style: 'tableDescription'}, { text: $("#extended-23").val(), style: 'tableValue'} ],
                  [ { text: 'Antal år till byte av växelriktare [' + $("#extended-unit-24").text() + ']', style: 'tableDescription'}, { text: $("#extended-24").val(), style: 'tableValue'} ],
                  [ { text: 'Kostnad för byte av växelriktare [' + $("#extended-unit-25").text() + ']', style: 'tableDescription'}, { text: $("#extended-25").val(), style: 'tableValue'} ],

                  [ { text: 'Driftkostnader', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Elcertifikathantering [' + $("#extended-unit-30").text() + ']', style: 'tableDescription'}, { text: $("#extended-30").val(), style: 'tableValue'} ],
                  [ { text: 'Fastighetsskatt [' + $("#extended-unit-31").text() + ']', style: 'tableDescription'}, { text: $("#extended-31").val(), style: 'tableValue'} ],
                  [ { text: 'Inmatningsabonnemang [' + $("#extended-unit-32").text() + ']', style: 'tableDescription'}, { text: $("#extended-32").val(), style: 'tableValue'} ],
                  [ { text: 'Loggning [' + $("#extended-unit-33").text() + ']', style: 'tableDescription'}, { text: $("#extended-33").val(), style: 'tableValue'} ],
                  [ { text: 'Resor [' + $("#extended-unit-34").text() + ']', style: 'tableDescription'}, { text: $("#extended-34").val(), style: 'tableValue'} ],
                  [ { text: 'Servitut [' + $("#extended-unit-35").text() + ']', style: 'tableDescription'}, { text: $("#extended-35").val(), style: 'tableValue'} ],
                  [ { text: 'Uttagsabonnemang [' + $("#extended-unit-36").text() + ']', style: 'tableDescription'}, { text: $("#extended-36").val(), style: 'tableValue'} ],
                  [ { text: 'Övrigt [' + $("#extended-unit-37").text() + ']', style: 'tableDescription'}, { text: $("#extended-37").val(), style: 'tableValue'} ],
                  [ { text: 'Summa årlig fast driftkostnad [' + $("#extended-unit-38").text() + ']', style: 'tableDescription'}, { text: $("#extended-38").val(), style: 'tableValue'} ],
                  [ { text: 'Försäkring [' + $("#extended-unit-41").text() + ']', style: 'tableDescription'}, { text: $("#extended-41").val(), style: 'tableValue'} ],
                  [ { text: 'Hyra av yta [' + $("#extended-unit-42").text() + ']', style: 'tableDescription'}, { text: $("#extended-42").val(), style: 'tableValue'} ],
                  [ { text: 'Underhåll av yta [' + $("#extended-unit-43").text() + ']', style: 'tableDescription'}, { text: $("#extended-43").val(), style: 'tableValue'} ],
                  [ { text: 'Rengöring av moduler [' + $("#extended-unit-44").text() + ']', style: 'tableDescription'}, { text: $("#extended-44").val(), style: 'tableValue'} ],
                  [ { text: 'Tillsyn [' + $("#extended-unit-45").text() + ']', style: 'tableDescription'}, { text: $("#extended-45").val(), style: 'tableValue'} ],
                  [ { text: 'Summa årlig rörlig driftkostnad [' + $("#extended-unit-46").text() + ']', style: 'tableDescription'}, { text: $("#extended-46").val(), style: 'tableValue'} ],

                  [ { text: 'Restvärde', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Restvärde [' + $("#extended-unit-50").text() + ']', style: 'tableDescription'}, { text: $("#extended-50").val(), style: 'tableValue'} ],
                  [ { text: 'Rivningskostnad [' + $("#extended-unit-51").text() + ']', style: 'tableDescription'}, { text: $("#extended-51").val(), style: 'tableValue'} ],
                  [ { text: 'Summa kostnader vid avslut [' + $("#extended-unit-52").text() + ']', style: 'tableDescription'}, { text: $("#extended-52").val(), style: 'tableValue'} ],

                  [ { text: 'Systemdegradering', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Årlig degradering av utbytet [' + $("#extended-unit-56").text() + ']', style: 'tableDescription'}, { text: $("#extended-56").val(), style: 'tableValue'} ],

                  [ { text: 'Energiutbyte', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Tillgänglighet [' + $("#extended-unit-60").text() + ']', style: 'tableDescription'}, { text: $("#extended-60").val(), style: 'tableValue'} ],

                  [ { text: 'Intäkter', style: 'sectionHeader'}, { text: '', } ],
                  [ { text: 'Antal år med elcertifikat [' + $("#extended-unit-64").text() + ']', style: 'tableDescription'}, { text: $("#extended-64").val(), style: 'tableValue'} ],
                  [ { text: 'Skattereduktion [' + $("#extended-unit-65").text() + ']', style: 'tableDescription'}, { text: $("#extended-65").val(), style: 'tableValue'} ],
                  [ { text: 'Tak för skattereduktion [' + $("#extended-unit-66").text() + ']', style: 'tableDescription'}, { text: $("#extended-66").val(), style: 'tableValue'} ],
                ]
              },
              layout: 'lightHorizontalLines',
            }
